          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <div className="mt-8 flex space-x-4">
                <a href="https://github.com/shoppinh" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 text-orange-500 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 transition-colors duration-300">
                ...
                <a href="https://www.linkedin.com/in/kien-mac-trung-679829193/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 text-orange-500 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 transition-colors duration-300">
                ...
                <a href="https://x.com/Kienneik1" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center rounded-full bg-white dark:bg-gray-800 text-orange-500 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 transition-colors duration-300">
